...
- Study start date: **-**
- Study end date: **-**
- Protocol: [**pdf file**](https://github.com/ohdsi-studies/Covid19VaccineAesiIncidenceCharacterization/blob/master/extras/Vaccine_safety_sensitivity_protocol.pdf)
- Publications: **-**
- Results explorer: **-**
